 ...
 */
const getServingContainers = (services) =>
  _(services)
 ...
 * Helper to find containers that serve
 */
const getOtherServingContainers = (services) =>
  _(services)
 ...
 * Helper to find containers that serve
 */
const getPythonContainers = (services) =>
  _(services)
...
exports.getLandoProxyRoutes = (services, domain, proxy = {}) => {
  ...
  const otherServingContainers = nginxServers.concat(
    getOtherServingContainers(services)
  );
